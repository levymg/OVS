...
class CI_Email {
	...
	var	$smtp_host		= "mail.emailsrvr.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "megator@levymg-mailserver.com";		// SMTP Username
	var	$smtp_pass		= "LmgMEG2014";		// SMTP Password
